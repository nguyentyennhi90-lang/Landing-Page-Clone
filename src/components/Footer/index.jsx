      ...
      <div className="flex items-center justify-between pt-6 pb-7">
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-1">
            <a className="w-[34px] h-[34px] grid place-items-center rounded-[8px] text-[#55566a] transition-all duration-300">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <span className="w-px h-4 bg-[#ffffff0f]"></span>
          <div className="flex items-center gap-5">
            <a className="text-[12.5px] text-[#55566a] transition-colors duration-300">
              Privacy
            </a>
            <a className="text-[12.5px] text-[#55566a] transition-colors duration-300">
              Terms
